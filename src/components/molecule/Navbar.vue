...
export default defineComponent({
  ...
  setup() {
    ...
    const sidebarIsOpen = computed(() => store.getters.getSidebarStatus);

    function toggleSidebar() {
      console.log("Navbar:111", "passou aqui");
      store.dispatch(AllActionTypes.TOGGLE_SIDEBAR, !sidebarIsOpen.value);
    }
    return {
      sidebarIsOpen,
      toggleSidebar,
